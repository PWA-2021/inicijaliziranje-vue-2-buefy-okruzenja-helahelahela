        ...
        <div id="sadrzaj">
            <div id="login">
                ...
                <form class="prijava" @submit.prevent="pressed">
                    <div class="login">
                    <input type="email" class="log" placeholder="Enter E-mail" name="email" id="email" v-model="email" required>
                    </div>

                    <div class="password">
                    <input type="password" class="log" placeholder="Enter Password" name="password" id="password" v-model="password" required>
                    </div>
